...
b = box.Box(evolution_time=10, conduction=True, settling_mode='stokes terminal', radioactivity=True,
            chemistry=True, verbose=True, multiprocessing=True, num_processors=2)
...
for i in range(1):
    b.insert_object(material='test_object', temperature=2000, radius=0.01, x=random.uniform(0, x),
                    ...
                    conductivity=0.05, density=2500)
