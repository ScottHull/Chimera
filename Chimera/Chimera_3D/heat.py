...
def conduction(coords, index, len_coords, x_plus_indices, x_minus_indices, y_plus_indices, y_minus_indices, z_plus_indices,
               z_minus_indices, temperatures, object_ids, spatial_res, conductivities, delta_time, real_delta_time,
               mesh_indices, update_temps, update_dT_dt, num_workers, multiprocess=False):
    ...
    return update_temps, update_dT_dt

    # else:
    #     update_temps, update_dT_dt = multiprocess_conduction_manager(coords=coords, len_coords=len_coords,
...
# def multiprocess_conduction(coords, index, len_coords, x_plus_indices, x_minus_indices, y_plus_indices, y_minus_indices, z_plus_indices,
#                z_minus_indices, temperatures, object_ids, spatial_res, conductivities, delta_time, mesh_indices,
#                num_workers, update_temps, update_dT_dt, multiprocess=True):
#
...
#     update_dT_dt = mp.Array('d', len_coords)
#
#     jobs = []
#
...
def object_conduction(object_temperatures, object_index, object_k, matrix_k, mesh_temperatures, copy_mesh_temperatures, 
    ...
    box_delta_time = backends.override_timestep(
        spatial_res=box_spatial_res,
        conductivities=None,
...
def viscous_dissipation(drag_coeff, matrix_density, object_radius, object_density, object_velocity, delta_time, cp,
    ...
    fd = dynamics.drag_force(
        drag_coeff=drag_coeff,
        matrix_density=matrix_density,
        object_radius=object_radius,
        distance_travelled=distance_travelled,
        delta_time=delta_time)
    fb = dynamics.buoyant_force(
        matrix_density=matrix_density,
        grav_accel=grav_accel,
        object_radius=object_radius
    )
    fg = dynamics.grav_force(
        object_radius=object_radius,
