...
def get_neighbor_index(coord, max_x, max_y, max_z, verbose, spatial_res):
    index = backends.predict_index(coord=coord, max_x=max_x, max_y=max_y, max_z=max_z, spatial_res=spatial_res,
                                   verbose=verbose)
    return index

def get_neighbors(verbose, coords, spatial_res, spatial_sigfigs, max_x, max_y,
    ...
    if max_z is not False:
        if min_x < x_coord < max_x:
            ...
            x_plus_index = get_neighbor_index(coord=x_plus_coord, max_x=max_x, max_y=max_y,
                                              max_z=max_z, spatial_res=spatial_res, verbose=verbose)
            x_minus_index = get_neighbor_index(coord=x_minus_coord, max_x=max_x, max_y=max_y,
                                              max_z=max_z, spatial_res=spatial_res, verbose=verbose)
        ...
        if min_y < y_coord < max_y:
            ...
            y_plus_index = get_neighbor_index(coord=y_plus_coord, max_x=max_x, max_y=max_y,
                                              max_z=max_z, spatial_res=spatial_res, verbose=verbose)
            y_minus_index = get_neighbor_index(coord=y_minus_coord, max_x=max_x, max_y=max_y,
                                              max_z=max_z, spatial_res=spatial_res, verbose=verbose)
        ...
        if min_z < z_coord < max_z:
            ...
            z_plus_index = get_neighbor_index(coord=z_plus_coord, max_x=max_x, max_y=max_y,
                                              max_z=max_z, spatial_res=spatial_res, verbose=verbose)
            z_minus_index = get_neighbor_index(coord=z_minus_coord, max_x=max_x, max_y=max_y,
                                              max_z=max_z, spatial_res=spatial_res, verbose=verbose)
