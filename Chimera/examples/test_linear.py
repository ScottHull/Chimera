...
line.insert_matrix(material='test_material_1', initial_temp=2800, conductivity=0.5, temp_grad=0.1, depth_range=[10.0, 4000.0])
...
line.insert_matrix(material='test_material_5', initial_temp=2800, conductivity=0.5, temp_grad=0.1, depth_range=[8005.0, 9990.0])

# insert boundary layers
line.insert_boundary(temperature=3000, depth_range=[0.0, 5.0])
line.insert_boundary(temperature=3000, depth_range=[9995.0, 10000.0])
